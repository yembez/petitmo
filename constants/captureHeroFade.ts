...
/** Beige test — aligné fond écran Capturer. */
export const CAPTURE_FADE_BASE_RGB = CAPTURE_SCREEN_BG_RGB;

/** Fond bandeau CTA + bas du dégradé photo. */
export const CAPTURE_FADE_BASE_HEX = CAPTURE_SCREEN_BG;
